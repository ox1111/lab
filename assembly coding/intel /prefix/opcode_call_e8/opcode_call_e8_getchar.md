...
2~3 (16비트)	         Base[15:0]	               2B	    세그먼트 시작 주소 하위 16비트
4   (8비트)	          Base[23:16]	              1B	    시작 주소의 중간 부분
5   (8비트)	          Access Byte (Type/DPL)	   1B	    세그먼트 타입, 접근 권한 등
6   (4비트 + 4비트)	   Flags + Limit[19:16]	     1B	    상위 Limit + Flags
7   (8비트)	          Base[31:24]	              1B	    시작 주소의 상위 부분
```
